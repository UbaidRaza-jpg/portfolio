...
[![Live Demo](https://img.shields.io/badge/Live-Demo-00f0ff?style=for-the-badge&logo=github)](https://ubaidraza-jpg.github.io/portfolio/)
[![GitHub](https://img.shields.io/badge/GitHub-UbaidRaza--jpg-e6ca65?style=for-the-badge&logo=github)](https://github.com/UbaidRaza-jpg)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin)](https://linkedin.com/in/muhammad-ubaid-raza-9b2912297)
...
The concept mirrors a live football broadcast matchday experience:
- **Pre-match lineup reveal** — projects pop onto a 3D tactical pitch one by one
- **3D FUT/EA Sports style player card** — with real photo, stats, and holographic tilt effect
- **VAR Match Report modals** — clicking a project opens a deep-dive technical analysis
- **Synthesized Web Audio engine** — referee whistle, stadium crowd ambiance (zero MP3 files)
- **Live Broadcast HUD** — sticky matchday ticker with transfer status
...
| Logic | Vanilla JavaScript (ES6+, Web Audio API, IntersectionObserver) |
| Fonts | Google Fonts (Outfit, Rajdhani, JetBrains Mono) |
